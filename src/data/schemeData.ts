...
export const FINANCIAL_INCLUSION_SCHEMES: FinancialInclusionScheme[] = [
  ...
  scheme("atal-pension-yojana", "employee", "Atal Pension Yojana", "Pension", "Official PFRDA page for Atal Pension Yojana.", "Eligible subscribers as per APY rules.", "Government-backed pension scheme information and guidance.", "https://www.pfrda.org.in/web/pfrda/schemes/atal-pension-yojana-apy", ["apy"]),
  ...
  scheme("stand-up-india", "self-employed", "Stand-Up India", "Enterprise Loan", "Official bank loan support portal for eligible entrepreneurs.", "Eligible SC/ST and women entrepreneurs as per scheme rules.", "Access guidance and bank loan support for greenfield enterprises.", "https://www.standupmitra.in", ["enterprise"]),
  ...
  scheme("birth-certificate", "citizen", "Birth Certificate", "Certificates", "Official portal or municipal service for Birth Certificate.", "Parents or individuals registering a birth.", "Provides official proof of birth and age.", "https://dc.crsorgi.gov.in/", ["birth registration"]),
  scheme("death-certificate", "citizen", "Death Certificate", "Certificates", "Official portal or municipal service for Death Certificate.", "Relatives registering a death.", "Provides official proof of death for legal and financial settlements.", "https://dc.crsorgi.gov.in/", ["death registration"]),
