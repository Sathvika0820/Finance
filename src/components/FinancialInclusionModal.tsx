...
import { X, ChevronDown, ExternalLink, Users } from "lucide-react";
import { useState } from "react";
import { FINANCIAL_INCLUSION_OPTIONS } from "@/data/smartServices";
      ...
      <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 pb-0">
        ...
        >
          ...
          <div className="shrink-0 p-5 pb-3 border-b border-border/50 flex items-center justify-between bg-white relative z-10">
            <div>
              <h2 className="text-xl font-bold text-foreground flex items-center gap-2">
                <Users className="w-5 h-5 text-blue-500 fill-blue-500/20" />
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-muted/10">
            {FINANCIAL_INCLUSION_OPTIONS.map((option) => {
                      ...
                      >
                        <div className="p-4 pt-3 space-y-3">
                          ...
                          <div className="flex justify-end pt-1">
                            ...
                            >
                              {option.id === "simple-banking-tutorials" || option.id === "voice-banking-help" ? t("learn") : t("openOfficialLink")}
