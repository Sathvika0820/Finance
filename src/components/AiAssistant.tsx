...
const LOCALIZED_TEXTS = {
  ...
  malayalam: {
    welcome: "നമസ്കാരം! ഞാൻ നിങ്ങളുടെ BankHub AI അസിസ്റ്റന്റാണ്. ബാങ്ക് സേവനങ്ങൾ, വായ്പകൾ, സർക്കാർ പദ്ധതികൾ, സുരക്ഷ എന്നിവയെക്കുറിച്ച് ചോദിക്കാം.",
    safetyWarning: "സുരക്ഷയ്ക്കായി OTP, PIN, CVV, കാർഡ് നമ്പർ, ബാങ്കിംഗ് പാസ്‌വേഡ് എന്നിവ BankHub-ൽ പങ്കിടരുത്.",
    fallback: "ഇത് ഔദ്യോഗിക ഉറവിടങ്ങളിൽ നിന്ന് സ്ഥിരീകരിക്കാൻ കഴിഞ്ഞില്ല. ദയവായി ഔദ്യോഗിക വെബ്സൈറ്റ് പരിശോധിക്കുക.",
    micUnsupported: "ഈ ബ്രൗസറിൽ വോയ്സ് ഇൻപുട്ട് പിന്തുണയ്ക്കുന്നില്ല. ദയവായി ടെക്സ്റ്റ് ഉപയോഗിക്കുക.",
    micListening: "കേൾക്കുന്നു... ഇപ്പോൾ സംസാരിക്കുക.",
    micProcessing: "വോയ്സ് ചോദ്യം പ്രോസസ്സ് ചെയ്യുന്നു...",
    micErrorNoSpeech: "ശബ്ദം കണ്ടെത്തിയില്ല. ദയവായി വീണ്ടും സംസാരിക്കാൻ ശ്രമിക്കുക.",
    micErrorDenied: "മൈക്രോഫോൺ അനുമതി നിഷേധിച്ചു. ബ്രൗസർ സെറ്റിംഗ്സിൽ മൈക്രോഫോൺ അനുവദിക്കുക.",
    micErrorDefault: "വോയ്സ് തിരിച്ചറിയൽ പിശക്. ദയവായി മൈക്രോഫോൺ പരിശോധിക്കുക അല്ലെങ്കിൽ ടെക്സ്റ്റ് ഉപയോഗിക്കുക.",
    ttsUnsupported: "ഈ ഉപകരണത്തിൽ വോയ്സ് ഔട്ട്പുട്ട് പിന്തുണയ്ക്കുന്നില്ല.",
    trustBanner: "BankHub ബാങ്കിംഗ് പാസ്‌വേഡ്, OTP, PIN, CVV എന്നിവ സംഭരിക്കുന്നില്ല.",
    placeholder: "പദ്ധതികൾ, വായ്പകൾ, രേഖകൾ എന്നിവയെക്കുറിച്ച് ചോദിക്കുക...",
    placeholderUnsupported: "എന്തും ചോദിക്കൂ... (വോയ്സ് ഇൻപുട്ട് പിന്തുണയ്ക്കുന്നില്ല)",
