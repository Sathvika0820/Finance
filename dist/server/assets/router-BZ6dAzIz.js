...
const appCss = "/assets/styles-C4ld-0wN.css";
...
const $$splitComponentImporter$4 = () => import("./favorites-Dadha3NH.js");
const Route$4 = createFileRoute("/favorites")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your saved banks for quick access."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./dashboard-DeNT1nuv.js");
const Route$3 = createFileRoute("/dashboard")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your one-tap home for Indian banking access."
    }]
  }),
...
function bank(id, name, shortName, category, website, logoDomain, description, services = ["Savings", "Loans", "Cards", "Mobile Banking"]) {
...
const $$splitComponentImporter$2 = () => import("./banks-B8FnWyEf.js");
const Route$2 = createFileRoute("/banks")({
  head: () => ({
    meta: [{
      title: "All Banks — Bank Hub"
    }, {
      name: "description",
      content: "Browse and search all supported Indian banks."
    }]
  }),
...
const $$splitComponentImporter$1 = () => import("./index-CXMGZW2E.js");
const Route$1 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./banks._bankId-DpQjZevp.js");
const $$splitErrorComponentImporter = () => import("./banks._bankId--XjIIXsD.js");
const $$splitNotFoundComponentImporter = () => import("./banks._bankId-CxjGzdp1.js");
const Route2 = createFileRoute("/banks/$bankId")({
  loader: ({
    params
  }) => {
    const bank2 = getBankById(params.bankId);
    if (!bank2) throw notFound();
    return {
      bank: bank2
    };
  },
  head: ({
    ...
    meta: loaderData ? [{
      ...
      name: "description",
      content: loaderData.bank.description
    }] : []
  }),
...
const BanksRoute = Route$2.update({
  id: "/banks",
  path: "/banks",
  getParentRoute: () => Route$5
});
...
const BanksBankIdRoute = Route2.update({
  id: "/$bankId",
  path: "/$bankId",
  getParentRoute: () => BanksRoute
});
const BanksRouteChildren = {
  BanksBankIdRoute
};
